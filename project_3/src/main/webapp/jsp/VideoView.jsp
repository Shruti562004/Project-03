...
<%@page import="in.co.rays.project_3.controller.VideoCtl"%>
...
<body class="p4">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.VIDEO_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Video</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<textarea name="duration" placeholder="Enter duration"
											class="form-control" rows="5" cols="5"><%=dto.getDuration()==0 ? "" :dto.getDuration() %></textarea>

									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("duration", request)%></font></br>
									<span class="pl-sm-5">
	<b>Views</b><span style="color: red;">*</span>
</span>
...
<div class="col-sm-12">
	<div class="input-group">
		...
		<input type="text" class="form-control" name="views"
			...
			value="<%=dto.getViews() == 0 ? "" : dto.getViews()%>">

	</div>
</div>

<font color="red" class="pl-sm-5">
	<%=ServletUtility.getErrorMessage("views", request)%>
</font>
								</div>
								</br>
								<%
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=VideoCtl.OP_UPDATE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=VideoCtl.OP_CANCEL%>">
								</div>
								<%
									} else {
								%>
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=VideoCtl.OP_SAVE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=VideoCtl.OP_RESET%>">
								</div>
								<%
									}
								%>

		...
		<form action="<%=ORSView.INVENTORY_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="text-primary font-weight-bold pt-3">
					<font color="black">Inventory List
				</h1>
				</font>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="supplier"
						...
						value="<%=ServletUtility.getParameter("supplier", request)%>">
				</div>
				...
				<table class="table table-dark table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><%=dto.getStock()%></td>
							<td align="center"><%=dto.getSupplier()%></td>
							
							<td align="center"><%=dto.getPrice()%></td>
							

							<td align="center"><a href="InventoryCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Inventory List</h1>
			</center>
			</br> </br>

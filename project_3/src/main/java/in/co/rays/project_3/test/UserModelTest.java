...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setRegisteredIP("Shruti Rathoretomar@gmail.com");
		dto.setLoginIP("Shruti Rathoretomar@gmail.com");

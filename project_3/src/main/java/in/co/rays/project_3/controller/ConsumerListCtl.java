...
/**
 * Consumer list ctl.to perform search and show list operation
 * 
 * @author Shruti Rathore
 *
 */
@WebServlet(name = "ConsumerListCtl", urlPatterns = { "/ctl/ConsumerListCtl" })

public class ConsumerListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(ConsumerListCtl.class);
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("Consumer list populate bean start");
	...
	dto.setCode(request.getParameter("code"));
		...
		log.debug("Consumer list populate bean end");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("Consumer list do get start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("Consumer list do post start");
		...
		try {
			if (OP_SEARCH.equalsIgnoreCase(op) || "next".equalsIgnoreCase(op) || "previous".equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					ConsumerDTO deletebean = new ConsumerDTO();
					for (String id : ids) {
